...
<body>
    <div class="container">
        <header class="header">
            ...
            <p>Liste de tous les statuts enregistrés</p>
        </header>
        ...
        <main class="main">
            <div class="actions">
                <h2>Actions</h2>
                <a href="${pageContext.request.contextPath}/statut?action=add" class="btn">Ajouter un nouveau statut</a>
            </div>
                        ...
                        <tbody>
                            <% for (Statut statut : statuts) { %>
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/statut?action=edit&id=<%= statut.getId() %>" class="btn btn-sm btn-primary">Modifier</a>
                                        <a href="${pageContext.request.contextPath}/statut?action=delete&id=<%= statut.getId() %>" class="btn btn-sm btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce statut ?')">Supprimer</a>
                                    </td>
                                </tr>
                            <% } %>
                        </tbody>
